...
export default function Main() {
   ...
   const startTimer = () => {
      this._interval = setInterval(() => {
        let currentTimerSeconds = timerSeconds;
        setTimerSeconds(currentTimerSeconds - 1);
     ...
     <View style={styles.mainContainer}>
       ...
       <View style={styles.bottomContainer}>
         ...
         <TouchableOpacity
            ...
            onPress={() => {
               console.log('wat');
               setTimerIsRunning === true ? setTimerIsRunning(false) : setTimerIsRunning(true);
               console.log(timerIsRunning)
               timerIsRunning === true ? startTimer() : stopTimer();
            }}
         >
