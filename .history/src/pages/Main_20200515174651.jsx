...
export default function Main() {
  ...
  return (
    <View style={styles.mainContainer}>
      {tab == 0 && <Oxygen startOnPress={(tab, time) => handleTimer(tab, time)} updateMaxTime={setMaxTime} />}
      {tab == 1 && <Carbon startOnPress={(tab, time) => handleTimer(tab, time)} updateMaxTime={setMaxTime} />}
